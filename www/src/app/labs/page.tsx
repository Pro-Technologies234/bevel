...
const LaunchpadApp = lazy(() => import("@/components/labs/launchpad/LaunchpadApp"));
const IntakeApp = lazy(() => import("@/components/labs/intake/IntakeApp"));
const BriefcaseApp = lazy(() => import("@/components/labs/briefcase/BriefcaseApp"));
...
const LABS = [
  {
    ...
    description: "A fully functional Google Drive-style app. Upload files, organise into folders, search with ⌘K, switch between grid and list views, star and delete — all wired up and working.",
  ...
  },
  {
    ...
    description: "A three-step account creation flow that lands in a real dashboard — then immediately walks new users through it with a guided product tour.",
  ...
  },
  {
    ...
    description: "A deployment dashboard for three projects with live metrics, deployment history, and a command palette for instant navigation — no clicks required.",
  ...
  },
  {
    ...
    description: "A multi-step job application with a branded left panel, role selection cards, conditional fields, and a full submission state — the kind of form that actually converts.",
    systems: ["Form Engine"],
    icon: IconUsers,
    accent: "#e879f9",
    component: IntakeApp,
  ...
  },
  {
    ...
    description: "A two-phase workflow: fill out the project brief, then upload the deliverables. Generates a receipt with revision count and a downloadable PDF summary.",
  ...
  },
  {
    ...
    description: "A settings page with five sections — Profile, Notifications, Appearance, Security, and API keys — navigable via sidebar or ⌘K, with a tour for first-time users.",
...
function SystemBadge({ name }: { name: string }) {
  const style = SYSTEM_COLORS[name] ?? { bg: "rgba(255,255,255,.08)", color: "rgba(255,255,255,.5)" };
  return (
    <span
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 mb-0.5">
            ...
            <span className="text-[10px] text-muted-foreground">{lab.tagline}</span>
          </div>
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <IconFlask size={15} strokeWidth={1.8} className="text-muted-foreground" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 text-center">
        ...
        <p className="text-base  max-w-xl mx-auto leading-relaxed font-light mb-2">
          Six fully functional applications built entirely with Bevel systems. Not demos — real working software you can use right now.
        </p>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <div className="flex gap-6 items-start">
          ...
          <div className="w-72 shrink-0 flex flex-col gap-2 sticky top-6">
            ...
            >
              ...
              <p className="text-[11px] text-muted-foreground leading-relaxed mb-3">
                All six Labs are included with Bevel Pro. Copy the code straight into your project.
              </p>
              <Button
                size="sm"
          ...
          <div className="flex-1 min-w-0">
              ...
              >
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <h2 className="text-xl font-bold tracking-tight">{activeLab.name}</h2>
                    <span className="text-sm text-muted-foreground">{activeLab.tagline}</span>
                  </div>
            ...
            >
              <span className="text-xs text-muted-foreground">Systems used in this lab:</span>
