    ...
    <section id="chip-select">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        >
          ...
          <Hint>
            Selected:{" "}
            {planOptions.find((o) => o.value === plan)?.label ?? "None"}
          </Hint>
        </ExampleCard>
        ...
        >
          ...
          <Hint>
            Status:{" "}
            {statusOptions.find((o) => o.value === status)?.label ?? "None"}
          </Hint>
        </ExampleCard>
        ...
        >
          ...
          />
          <Hint>
            {tags.length}/3 labels —{" "}
            {tags.length === 3 ? "limit reached" : "select up to 3"}
          </Hint>
        </ExampleCard>
      </div>
    </section>
