...
import { DemoIntro } from "./demo-chrome";
...
export function CommandPaletteDemo() {
  return (
    <div className="flex flex-col gap-4 w-full max-w-3xl">
      <DemoIntro eyebrow="Command Palette">
        ⌘K search across every source in your app — fuzzy matching, tab
        filtering by type, grouped results. It's already open below; type to
        filter, or press Esc and reopen it from the search bar in the mock app.
      </DemoIntro>
      ...
      <CommandPaletteRoot
        ...
        // Opens on mount — the results panel, tabs, and fuzzy search are the
        // actual product; a closed trigger button doesn't demonstrate any of it.
        defaultOpen={true}
