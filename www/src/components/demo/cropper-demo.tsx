...
export function CropperDemo() {
  ...
  return (
    <div className="w-full max-w-3xl flex flex-col gap-4">
      <DemoIntro eyebrow="Image Cropper">
        Eight-handle drag with aspect-ratio locking, a rule-of-thirds overlay,
        and export at full source resolution via an offscreen canvas — the
        live preview on the right updates as you drag.
      </DemoIntro>
