...
export function CursorsDemo() {
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      <DemoIntro eyebrow="Collaborative Cursors">
        Real-time presence for a shared surface — conflict-free position sync,
        idle fade-out, and a label-overlap resolver so names never stack when
        cursors cross. The four collaborators below are simulated and already
        moving; move your own cursor over the canvas to join them.
      </DemoIntro>
