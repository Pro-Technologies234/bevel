              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    !layer.visible &&
                      "opacity-30 line-through decoration-muted-foreground",
                  )}
                >
                  {layer.name}
                </span>
                ...
                <button
                  type="button"
                  onClick={() =>
                    layers.update(layer.id, { visible: !layer.visible })
                  }
                  title={layer.visible ? "Hide layer" : "Show layer"}
                  className="text-[11px] leading-none transition-colors shrink-0 w-5 text-center cursor-pointer"
                >
                  {layer.visible ? (
                    <IconEye size={16} />
                  ) : (
                    <IconEyeOff size={16} className=" text-destructive" />
                  )}
                </button>
              </SortableItem>
            ))}
