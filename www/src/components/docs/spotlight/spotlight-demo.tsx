...
import {
  IconUser, IconFolder, IconFileText,
  IconCode, IconSettings, IconSearch,
    ...
    <div className="flex flex-col items-center gap-5 py-8 px-4">
      <div className="flex flex-col items-center gap-2 text-center">
        <div className="w-12 h-12 rounded-xl bg-muted/40 border border-border flex items-center justify-center">
          <IconSearch size={20} className="text-muted-foreground/50" />
        </div>
        <p className="text-sm font-medium text-foreground">Spotlight Search</p>
        <p className="text-[12px] text-muted-foreground/60 max-w-xs">
          Async content search with categories and recent history.
          Distinct from Command Palette — results come from your API.
        </p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-[11px] text-muted-foreground/40">or press</span>
        <kbd className="text-[11px] font-mono px-1.5 py-0.5 rounded border border-border bg-muted/40 text-muted-foreground/60">
          /
        </kbd>
      </div>
